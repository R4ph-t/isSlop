...
export const CHROME_ATTR = /(?:^|[\s_-])(?:nav(?:bar|igation)?|sidebar|footer|cookie(?:s|banner|notice|consent)?|consent|onetrust|gdpr|newsletter|subscribe|mailchimp|comments?|disqus|related[-_]posts|social[-_]share|share[-_]buttons|advert(?:isement|orial)?|adsense|ad[-_]slot|paywall)(?:[\s_-]|$)/i;
...
export const MAX_TEXT_NODES = 4000;
